...
window.MEDICATIONS = {
    m21: {
        ...
        summary: `
            <div class="sum-card">
                <h3 style="color:var(--primary-accent);">💊 Hyoscine Butyl bromide</h3>
    ...
    m22: {
        ...
        summary: `
            <div class="sum-card">
                <h3 style="color:var(--primary-accent);">💊 Ketamine</h3>
                <h4>Classification</h4>
    ...
    m23: {
        ...
        summary: `
            <div class="sum-card">
                <h3 style="color:var(--primary-accent);">💊 Labetalol</h3>
                <h4>Classification</h4>
                <p>Beta Blocker</p>
                <h4>Presentation</h4>
    ...
    m24: {
        ...
        summary: `
            <div class="sum-card">
                <h3 style="color:var(--primary-accent);">💊 Magnesium Sulphate</h3>
                <h4>Classification</h4>
                <p>Electrolyte</p>
                <h4>Presentation</h4>
    ...
    m25: {
        ...
        summary: `
            <div class="sum-card">
                <h3 style="color:var(--primary-accent);">💊 Methoxyflurane (Penthrox)</h3>
                <h4>Classification</h4>
    ...
    m26: {
        ...
        summary: `
            <div class="sum-card">
                <h3 style="color:var(--primary-accent);">💊 Metoclopramide</h3>
                <h4>Classification</h4>
                <p>Antiemetic</p>
                <h4>Presentation</h4>
    ...
    m27: {
        ...
        summary: `
            <div class="sum-card">
                <h3 style="color:var(--primary-accent);">💊 Midazolam</h3>
                <h4>Classification</h4>
                <p>Benzodiazepine</p>
                <h4>Presentation</h4>
    ...
    m28: {
        ...
        summary: `
            <div class="sum-card">
                <h3 style="color:var(--primary-accent);">💊 Morphine</h3>
                <h4>Classification</h4>
    ...
    m29: {
        ...
        summary: `
            <div class="sum-card">
                <h3 style="color:var(--primary-accent);">💊 Naloxone</h3>
                <h4>Classification</h4>
    ...
    m30: {
        ...
        summary: `
            <div class="sum-card">
                <h3 style="color:var(--primary-accent);">💊 Nefopam</h3>
                <h4>Classification</h4>
