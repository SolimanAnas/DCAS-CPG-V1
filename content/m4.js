...
window.MEDICATIONS = {
    m31: {
        ...
        summary: `
            <div class="sum-card">
                <h3 style="color:var(--primary-accent);">💨 Oxygen</h3>
    ...
    m32: {
        ...
        summary: `
            <div class="sum-card">
                <h3 style="color:var(--primary-accent);">💊 Paracetamol (Acetaminophen)</h3>
                <h4>Classification</h4>
    ...
    m33: {
        ...
        summary: `
            <div class="sum-card">
                <h3 style="color:var(--primary-accent);">💊 Pethidine</h3>
                <h4>Classification</h4>
    ...
    m34: {
        ...
        summary: `
            <div class="sum-card">
                <h3 style="color:var(--primary-accent);">💊 Racemic Epinephrine (Adrenaline)</h3>
                <h4>Classification</h4>
    ...
    m35: {
        ...
        summary: `
            <div class="sum-card">
                <h3 style="color:var(--primary-accent);">💧 Ringers Lactate</h3>
                <h4>Classification</h4>
    ...
    m36: {
        ...
        summary: `
            <div class="sum-card">
                <h3 style="color:var(--primary-accent);">💊 Salbutamol</h3>
                <h4>Classification</h4>
    ...
    m37: {
        ...
        summary: `
            <div class="sum-card">
                <h3 style="color:var(--primary-accent);">💧 Sodium Chloride 0.9% (Normal Saline)</h3>
                <h4>Classification</h4>
                <p>Isotonic Crystalloid</p>
                <h4>Presentation</h4>
    ...
    m38: {
        ...
        summary: `
            <div class="sum-card">
                <h3 style="color:var(--primary-accent);">💊 Tranexamic Acid</h3>
                <h4>Classification</h4>
